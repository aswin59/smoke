...
public class AppiumFunctions extends Drivers{
	...
	public static void Check_feed3_ad() throws Exception
	{
		...
		try{
			...
			if(feedad.isDisplayed())
			{
				logStep("feed3 ad present on the screen");
				System.out.println("feed3 ad present on the screen");
				ScreenShot("feed_3","Passed");
				logStep("took the feed3 passed screenshot");
		...
		{
			logStep("feed3 ad not present on the screen");
